...
//  https://github.com/robinzhangx/LruCache

#import "ObjcLRLCache.h"

@implementation ObjcLRLCache {
...
- (NSString *)description
{
    ...
    return [NSString stringWithFormat:@"ObjcLRLCache[maxSize=%ld,size=%ld,items=%ld,hits=%ld,misses=%ld,hitRate=%ld%%]",
